...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        if (ld_vector) begin
            ...
            else if ((OPdest_q2==JMPA_) && wrcycl && ~Ind_Dest_q2 && thread_q2_sel) PC_COPY[15:0] <= wrsrcAdata[15:0];  
            else PC_COPY <= (break_q0 && newthreadq_sel) ? pc_q2[15:0] : pc_q2[15:0] + 1'b1; 
        end   
