...
wire [2:0] ARn_sel_q0;
assign ARn_sel_q0 = OPsrcA_q0[2:0];                                                                                         
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        if ( ((Dam_q0[1:0]==2'b01) && (OPdest_q0==REPEAT_addrs)) && ~RPT_not_z && thread_q0_sel && ~Ind_Dest_q0) REPEAT[10:0] <= OPsrcB_q0[10:0]; //load REPEAT reg with 11-bit immediate during q0
            ...
            casex(ARn_sel_q0)
                3'b000 : REPEAT[10:0] <= AR0[10:0];  //load REPEAT reg with contents of specified ARn
                3'b001 : REPEAT[10:0] <= AR1[10:0];  //load REPEAT reg with contents of specified ARn
                3'b010 : REPEAT[10:0] <= AR2[10:0];  //load REPEAT reg with contents of specified ARn
                3'b011 : REPEAT[10:0] <= AR3[10:0];  //load REPEAT reg with contents of specified ARn
                3'b100 : REPEAT[10:0] <= AR4[10:0];  //load REPEAT reg with contents of specified ARn
                3'b101 : REPEAT[10:0] <= AR5[10:0];  //load REPEAT reg with contents of specified ARn
                3'b110 : REPEAT[10:0] <= AR6[10:0];  //load REPEAT reg with contents of specified ARn
                  default : REPEAT[10:0] <= 10'h0_00;
            endcase
        end
        else if (auto_post_modify_instr && ~int_in_service && ~break_q0) REPEAT[10:0] <= REPEAT[10:0] - 1'b1;  
    end
end        
