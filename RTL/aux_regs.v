...
always @(*) begin
     case (DEST_ARn_sel) 
     	...
     	3'b111 : DEST_ind = (Imod_Dest_q2 && Ind_Dest_q2) ?  SP[17:0] + {{6{OPdest_q2[15]}}, OPdest_q2[15:3]}        :  SP[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]}; 
     endcase
end
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
       ...
       SP  <= 18'h0_0FF8;             //initialize to middle of direct RAM
        ...
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR0_ADDRS[15:0]) AR0[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR1_ADDRS[15:0]) AR1[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR2_ADDRS[15:0]) AR2[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR3_ADDRS[15:0]) AR3[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR4_ADDRS[15:0]) AR4[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR5_ADDRS[15:0]) AR5[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==AR6_ADDRS[15:0]) AR6[17:0] <= wrsrcAdata[17:0];                                                  
        ...
        //direct or table-read loads of ARn occur during usual write (state2)
        if (wrcycl && ~Ind_Dest_q2 && thread_q2_sel && OPdest_q2[15:0]==SP_ADDRS[15:0] )  SP[17:0] <= wrsrcAdata[17:0];
                                                          
//auto-post-modification section 
            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b000) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR0[17:0] <= AR0[17:0] +  {{6{OPsrcA_q0[14]}}, OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b000) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR0[17:0] <= AR0[17:0] +  {{6{OPsrcB_q0[14]}}, OPsrcB_q0[14:3]};
            ...
            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b001) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR1[17:0] <= AR1[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b001) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR1[17:0] <= AR1[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b001) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR1[17:0] <= AR1[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b010) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR2[17:0] <= AR2[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b010) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR2[17:0] <= AR2[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b010) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR2[17:0] <= AR2[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b011) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR3[17:0] <= AR3[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b011) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR3[17:0] <= AR3[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b011) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR3[17:0] <= AR3[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b100) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR4[17:0] <= AR4[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b100) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR4[17:0] <= AR4[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b100) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR4[17:0] <= AR4[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b101) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR5[17:0] <= AR5[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b101) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR5[17:0] <= AR5[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b101) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR5[17:0] <= AR5[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b110) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0) AR6[17:0] <= AR6[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b110) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0) AR6[17:0] <= AR6[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
            if ((wrcycl && OPdest_q2[2:0]==3'b110) && thread_q2_sel && Ind_Dest_q2 && ~Imod_Dest_q2) AR6[17:0] <= AR6[17:0] + {{6{OPdest_q2[14]}}, OPdest_q2[14:3]};

            //auto post modification of ARs and SP for read cycle occur after state 1
            if ((OPsrcA_q0[2:0]==3'b111) && newthreadq_sel && Ind_SrcA_q0 && ~&Dam_q0[1:0] && ~Imod_SrcA_q0)  SP[17:0] <=  SP[17:0] +  {{6{OPsrcA_q0[14]}},  OPsrcA_q0[14:3]};
            if ((OPsrcB_q0[2:0]==3'b111) && newthreadq_sel && Ind_SrcB_q0 && ~Dam_q0[0] && ~Imod_SrcB_q0)  SP[17:0] <=  SP[17:0] +  {{6{OPsrcB_q0[14]}},  OPsrcB_q0[14:3]};
            //auto post modification of ARs and SP for write cycle occur after state 2
