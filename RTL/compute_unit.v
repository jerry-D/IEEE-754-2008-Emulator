...
assign rdcycl = 1'b1;
assign wrcycl = STATE[3] && fp_ready_q2 && ready_integer_q2;

wire [63:0] mon_write_reg;

wire tr0_RM_Attribute_on;
wire tr1_RM_Attribute_on;
wire tr2_RM_Attribute_on;
wire tr3_RM_Attribute_on;
...
always @(*) 
    case(newthreadq)
        2'b00 : RM_q0[1:0] = tr0_RM_Attribute_on ? tr0_RM[1:0] : Instruction_q0_del[63:62]; 
        2'b01 : RM_q0[1:0] = tr1_RM_Attribute_on ? tr1_RM[1:0] : Instruction_q0_del[63:62]; 
        2'b10 : RM_q0[1:0] = tr2_RM_Attribute_on ? tr2_RM[1:0] : Instruction_q0_del[63:62]; 
        2'b11 : RM_q0[1:0] = tr3_RM_Attribute_on ? tr3_RM[1:0] : Instruction_q0_del[63:62]; 
    endcase
...
fpmath fpmath( 
   ...
   .tr0_C_reg(tr0_C_reg[65:0] ),
   .tr1_C_reg(tr1_C_reg[65:0] ),
   .tr2_C_reg(tr2_C_reg[65:0] ),
   .tr3_C_reg(tr3_C_reg[65:0] ),
...
thread_unit thread0 (                                         
    ...
    .writeAbort     (tr0_writeAbort   ), 
    .RM_Attribute_on(tr0_RM_Attribute_on),
    .Away           (tr0_Away         ),
    .RM_Attribute   (tr0_RM           ),       
...
thread_unit thread1 (
    ...
    .fp_ready_q1    (fp_ready_q1      ),                             
    .fp_ready_q2    (fp_ready_q2      ),                
    .writeAbort     (tr1_writeAbort   ),
    .RM_Attribute_on(tr1_RM_Attribute_on),
    .Away           (tr1_Away         ),
    .RM_Attribute   (tr1_RM           ),                      
...
thread_unit thread2 (
    ...
    .fp_ready_q1    (fp_ready_q1      ),                             
    .fp_ready_q2    (fp_ready_q2      ), 
    .writeAbort     (tr2_writeAbort   ),           
    .RM_Attribute_on(tr2_RM_Attribute_on),
    .Away           (tr2_Away         ),
    .RM_Attribute   (tr2_RM           ),       
...
thread_unit thread3 (
    ...
    .fp_ready_q1    (fp_ready_q1      ),                             
    .fp_ready_q2    (fp_ready_q2      ),
    .writeAbort     (tr3_writeAbort   ),           
    .RM_Attribute_on(tr3_RM_Attribute_on),
    .Away           (tr3_Away         ),
    .RM_Attribute   (tr3_RM           ),       
