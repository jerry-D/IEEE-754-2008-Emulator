...
//per IEEE754-2008, +inf input yeilds +inf result and -inf input yeilds +0 result, both without producing an exception
assign Result =  A_is_infinite_del ? {3'b000, {5{~A_sign_del}}, 10'b0} : R18;
