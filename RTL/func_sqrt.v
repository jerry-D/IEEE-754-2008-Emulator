...
//FloPoCo exception codes  (except for sqrt)
...
assign invalid = A_sign_del && wren_del_2 && ~A_is_zero_del; // A is a negative non-zero number (including infinity)
...
FPSqrt610 FPSqrt610(
    ...
    .rst (RESET ),
    .X   (wrdataA),
    .R   (R610 ),            //FP610 representation is 19 bits, which includes FloPoCo 2-bit exception code
    .IEEEg_d1 (guard ),     
    .IEEEr_d1 (round ),     
    .IEEEs_d1 (sticky),
    .roundit  (1'b0  )    
